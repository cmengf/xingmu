<template>
  <div id="box1">
    ...
    <el-table :data="pass"   style="width: 1200px;" >
      <el-table-column label="活动标题" width="200px">
      ...
      <el-table-column label="活动详情" width="200px">
        <template slot-scope="scope">
      ...
      <br>
    <el-form-item>
      <el-button class="aa" type="primary" @click="onSubmit">立即创建</el-button>
    </el-form-item>
  </el-form>
  </div>
</template>
